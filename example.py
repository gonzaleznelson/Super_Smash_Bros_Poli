...
parser.add_argument('--dolphin_executable_path', '-e', default="C:/Users/gonza/AppData/Roaming/Slippi Launcher/netplay/",
                    help='The directory where dolphin is')
parser.add_argument('--connect_code', '-t', default="YIDH#618",
...
while True:
    ...
    if gamestate.menu_state in [melee.Menu.IN_GAME, melee.Menu.SUDDEN_DEATH]:
        ...
        if gamestate.distance < 4:
            ...
            onleft = gamestate.player[2].x < gamestate.player[1].x
            ...
            if gamestate.player[2].y < gamestate.player[1].y:
